...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pg_preview = GraphicsLayoutWidget(self.groupBox_7)
        self.pg_preview.setObjectName(u"pg_preview")
        sizePolicy1.setHeightForWidth(self.pg_preview.sizePolicy().hasHeightForWidth())
        self.pg_preview.setSizePolicy(sizePolicy1)

        self.gridLayout_6.addWidget(self.pg_preview, 0, 0, 1, 1)


        self.gridLayout.addWidget(self.groupBox_7, 3, 0, 1, 3)
        ...
        sizePolicy4.setHeightForWidth(self.label_graph.sizePolicy().hasHeightForWidth())
        self.label_graph.setSizePolicy(sizePolicy4)
        self.label_graph.setMinimumSize(QSize(400, 200))

        self.gridLayout_8.addWidget(self.label_graph, 0, 0, 1, 1)


        self.gridLayout_2.addWidget(self.groupBox_3, 1, 0, 1, 7)
        ...
        self.gridLayout_2.addWidget(self.groupBox_5, 0, 0, 1, 7)
        ...
        self.gridLayout_2.addWidget(self.pushButton_updatemodel, 6, 0, 1, 1)
        ...
        sizePolicy6.setHeightForWidth(self.display.sizePolicy().hasHeightForWidth())
        self.display.setSizePolicy(sizePolicy6)
        font1 = QFont()
        ...
        sizePolicy9.setHeightForWidth(self.spinBox_num_workers.sizePolicy().hasHeightForWidth())
        self.spinBox_num_workers.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.spinBox_num_tries.sizePolicy().hasHeightForWidth())
        self.spinBox_num_tries.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setHeightForWidth(self.comboBox_opt_method.sizePolicy().hasHeightForWidth())
        self.comboBox_opt_method.setSizePolicy(sizePolicy10)
        ...
        sizePolicy9.setHeightForWidth(self.pushButton_fit.sizePolicy().hasHeightForWidth())
        self.pushButton_fit.setSizePolicy(sizePolicy9)
        ...
        sizePolicy11.setHeightForWidth(self.progressBar_fit.sizePolicy().hasHeightForWidth())
        self.progressBar_fit.setSizePolicy(sizePolicy11)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1482, 33))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_7.setTitle(QCoreApplication.translate("MainWindow", u"Preview", None))
